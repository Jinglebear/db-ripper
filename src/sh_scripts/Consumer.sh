...
python3 "$path"/src/KafkaConsumerParking.py >> "$path"/misc/logs/logKafkaConsumerParking.log 2>> "$path"/misc/err_logs/ErrLogConsumerParking.log&
python3 "$path"/src/KafkaConsumerWeather.py >> "$path"/misc/logs/logKafkaConsumerWeather.log 2>> "$path"/misc/err_logs/ErrLogConsumerWeather.log&