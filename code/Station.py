...
### computeEvaNums
#
# @param cities(array containing city names that own railway stations)
...
def computeEvaNums(cityIDs, base_request_string, authToken,resultArr):
    headers = {
...
resultArr = []
computeEvaNums(cityIDs,base_request_string,'Bearer 873be58d3db312b4e52a2102e5641c27',resultArr)
